        ...
        <div class="page-footer-container">
            <div class="page-footer-top">
                ...
                <div class="page-footer-content">
                    <div class="page-footer-content-left">
                        <p class="page-footer-content-title">青少年编程</p>
                        <div class="page-footer-links-box">
                    ...
                    <div class="page-footer-content-right">
                        <p class="page-footer-content-title">友情链接</p>
                        <ul class="page-footer-links">
                            <li>腾讯游戏追梦计划</li>
                            <li>小鹅营地</li>
                            <li>智启学堂</li>
            ...
            <div class="page-footer-bottom">
                <span class="copyright">Copyright © 1998 - 2022 Tencent. All Rights Reserved. 腾讯公司 版权所有</span>
                <p class="links">
                    <span @click="alertText('服务协议')">服务协议</span>
                    <span class="divider">|</span>
                    <span @click="alertText('隐私政策')">隐私政策</span>
                    <span class="divider">|</span>
                    <span @click="alertText('版权保护投诉指引')">版权保护投诉指引</span>
                </p>
            </div>
        </div>
    </footer>
...
.page-footer{
    ...
    .page-footer-top{
        ...
        .page-footer-logo{
            ...
            width: 180px;
            height: 52px;
            background-image: url(@logo-coding-large);
